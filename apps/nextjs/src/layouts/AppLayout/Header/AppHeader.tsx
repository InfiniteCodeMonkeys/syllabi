        ...
        >
          ...
          {isSignedIn ? (
            ...
            <div className="hidden md:flex md:items-center md:space-x-6">
              ...
              >
                <span className="inline-flex items-center rounded-md border border-transparent bg-gray-600 px-4 py-2 text-base font-medium text-white hover:bg-gray-700">
                  Sign Up Free
                </span>
              </Link>
            </div>
              ...
              {isSignedIn ? (
                <>
                  <div className="space-y-1 px-2">
                    <Link href="/dashboard">
                      <div className="block rounded-md px-3 py-2 text-base font-medium text-white hover:underline">
                        Dashboard
                      </div>
                    </Link>
                    <a
